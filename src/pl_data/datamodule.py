...
class JointDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(
        ...
        dl = DataLoader(
            dataset=self.train_ds,
            batch_size=batch_size,
            collate_fn=JointDataset.collate_fn(online=self.train_ds.online),
            shuffle=shuffle,
        )
    ...
    def val_dataloader(self) -> Union[DataLoader, List[DataLoader]]:
        ...
        dl = DataLoader(
            dataset=self.val_ds,
            batch_size=batch_size,
            collate_fn=JointDataset.collate_fn(online=self.val_ds.online),
            shuffle=shuffle,
        )
    ...
    def test_dataloader(self) -> Union[DataLoader, List[DataLoader]]:
        ...
        dl = DataLoader(
            dataset=self.test_ds,
            batch_size=batch_size,
            collate_fn=JointDataset.collate_fn(online=self.test_ds.online),
            shuffle=shuffle,
        )
